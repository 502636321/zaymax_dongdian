    ...
    <div class="panel panel-default">
        ...
        <#include "../../public/ALERT_MESSAGE.ftl" />
            <form class="form-horizontal" action="/admin/system/user/save" method="post" >
                ...
                <div class="form-group">
                    <label for="password" class="col-md-2 control-label"><@spring.message code="user_attribute_password" /></label>
                    <div class="col-md-4">
                        <input type="password" class="form-control" id="password" name="password" value="${ (user.password)!"" }" >
                    </div>
                    <label for="repassword" class="col-md-2 control-label"><@spring.message code="user_attribute_repassword" /></label>
                    <div class="col-md-4">
