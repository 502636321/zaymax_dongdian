...
<script>
    $(function () {
        $('form[action="/admin/system/role/save"]').validate({
            rules: {
                'name': {
                    required : true,
                    remote: '/admin/system/role/exist'
                }
            },
            messages: {
                'name': {
                    required: '<@spring.message code="role_attribute_name_rule_required" />',
                    remote: '<@spring.message code="role_attribute_name_rule_exist" />'
                }
            }
        });
    });
