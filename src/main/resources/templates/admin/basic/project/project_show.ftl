...
<div class="table-responsive col-md-9">
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            <@spring.message code="project_action_show" />
        </div>
        <div class="panel-body">
            <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" value="${ (project.name)!"" }" disabled="disabled" >
                    </div>
                </div>
                <div class="form-group">
                    <label for="describe" class="col-sm-2 control-label">描述</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" id="describe" name="describe" rows="5" disabled="disabled" >${ (project.description)!"" }</textarea>
                    </div>
                </div>
                <div class="form-group">
