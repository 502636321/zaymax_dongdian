...
<div class="table-responsive col-md-9">
    <div class="panel panel-default">
        ...
        <@spring.message code="type_action_edit" />
        </div>
        <div class="panel-body">
        <#include "../../public/ALERT_MESSAGE.ftl" />
            <form class="form-horizontal" action="/admin/basic/type/edit/${ (type.id)!"" }" method="post" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description" name="description" rows="5" >${ (type.description)!"" }</textarea>
                    </div>
                </div>
                <div class="form-group">
