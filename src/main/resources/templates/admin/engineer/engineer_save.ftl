...
<head>
    ...
    <script>
        $(function () {
            ...
            $('form[action="/admin/engineer/save"]').validate({
                rules: {
                    'name': {
                        required : true
                    },
                ...
                messages: {
                    ...
                    'birthdate': {
                        required: '<@spring.message code="engineer_attribute_birthdate_rule_required" />'
                    },
                    'mobile': {
                        required: '<@spring.message code="engineer_attribute_mobile_rule_required" />',
                        isMobile: '<@spring.message code="engineer_attribute_mobile_rule_is_mobile" />'
                    },
                    'email': {
                        required: '<@spring.message code="engineer_attribute_email_rule_required" />',
                        email: '<@spring.message code="engineer_attribute_email_rule_email" />'
                    },
                    'education.id': {
                        required : '<@spring.message code="engineer_attribute_education_rule_required" />'
                    },
                    'educationPathFile': {
                        required : '<@spring.message code="engineer_attribute_education_path_rule_required" />',
                        extension: '<@spring.message code="engineer_attribute_education_path_rule_accept" />'
                    },
                    'cardNo': {
                        required : '<@spring.message code="engineer_attribute_card_no_rule_required" />',
                        rangelength: '<@spring.message code="engineer_attribute_card_no_rule_rangelength" />'
                    }
                }
            });
        });
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal col-md-offset-1 col-md-10" action="/admin/engineer/save" method="post" enctype="multipart/form-data" >
